/*
  # Resource System Migration Update
  
  This migration updates the resource system tables and policies.
  It first drops any existing tables to avoid conflicts.
*/
...
DROP FUNCTION IF EXISTS update_resource_helpfulness CASCADE;
...
DROP POLICY IF EXISTS "Anyone can read resource tags" ON resource_tags;
...
DROP POLICY IF EXISTS "Authors can update resources" ON resources;
DROP POLICY IF EXISTS "Authors can delete resources" ON resources;
DROP POLICY IF EXISTS "Anyone can read resource tag relations" ON resource_tag_relations;
DROP POLICY IF EXISTS "Authors can manage resource tags" ON resource_tag_relations;
DROP POLICY IF EXISTS "Anyone can read votes" ON resource_votes;
DROP POLICY IF EXISTS "Users can vote" ON resource_votes;
DROP POLICY IF EXISTS "Users can update own votes" ON resource_votes;
DROP POLICY IF EXISTS "Users can delete own votes" ON resource_votes;
DROP POLICY IF EXISTS "Users can read own bookmarks" ON resource_bookmarks;
DROP POLICY IF EXISTS "Users can manage own bookmarks" ON resource_bookmarks;
...
DROP INDEX IF EXISTS resource_tags_name_idx;
DROP INDEX IF EXISTS resources_author_id_idx;
DROP INDEX IF EXISTS resource_votes_resource_user_idx;
DROP INDEX IF EXISTS resource_bookmarks_user_idx;
...
DROP TRIGGER IF EXISTS resource_votes_update ON resource_votes;
